...
const learningPathsData = [
  ...
  {
    slug: "exploradores-da-natureza",
    title: "Exploradores da Natureza",
    description:
      "Percurso de Ciências para cultivar cuidados com o corpo, seres vivos e ambientes do cotidiano.",
    ageGroupSlug: "fundamental-anos-iniciais",
  },
  {
...
const usersData: UserSeed[] = [
  ...
  },
  {
    ...
    progress: [
      ...
      {
        contentModuleSlug: "brincando-com-sons",
        completion: 45,
        status: "IN_PROGRESS",
        totalAttempts: 3,
        currentStreak: 3,
        ...
        averageTimeSeconds: 105,
        mastery: 58,
      },
      {
        contentModuleSlug: "familia-das-vogais",
        completion: 32,
        status: "IN_PROGRESS",
        totalAttempts: 2,
        currentStreak: 2,
        ...
        averageTimeSeconds: 96,
        mastery: 47,
      },
      {
        contentModuleSlug: "palavras-em-acao",
        completion: 30,
        status: "IN_PROGRESS",
        totalAttempts: 2,
        currentStreak: 2,
      ...
      {
        contentModuleSlug: "frases-divertidas",
        completion: 18,
        status: "IN_PROGRESS",
        totalAttempts: 2,
        currentStreak: 1,
        bestStreak: 2,
        averageAccuracy: 0.8,
        averageTimeSeconds: 118,
        mastery: 38,
      },
      {
        contentModuleSlug: "bilhetes-e-recados",
        completion: 22,
        status: "IN_PROGRESS",
        totalAttempts: 1,
        currentStreak: 1,
    ...
    attempts: [
      ...
      {
        activitySlug: "som-inicial-surpresa",
        success: true,
        score: 96,
        accuracy: 0.94,
        timeSpentSeconds: 95,
        metadata: { sonsIdentificados: 4 },
      },
      {
        activitySlug: "vogal-exploradora",
        success: true,
        score: 88,
        accuracy: 0.9,
        timeSpentSeconds: 82,
        metadata: { letraSelecionada: "E" },
      },
      {
        activitySlug: "palavra-e-figura",
        success: true,
        score: 84,
        accuracy: 0.86,
        timeSpentSeconds: 100,
        metadata: { palavrasLidas: 6 },
      },
      {
        activitySlug: "frase-ilustrada",
        success: true,
        score: 92,
        accuracy: 0.93,
        timeSpentSeconds: 88,
        metadata: { resposta: "Dormindo no tapete." },
      },
      {
        activitySlug: "elementos-do-bilhete",
        success: true,
        score: 90,
        accuracy: 0.9,
        timeSpentSeconds: 78,
    ...
    rewards: [
      ...
      {
        code: "badge:explorador-vogais",
        title: "Explorador de Vogais",
        description: "Concluiu desafios de reconhecimento de sons e letras.",
        criteria: "Completar atividades dos módulos Brincando com Sons e Família das Vogais.",
        icon: "badge-vowels",
        category: "BADGE",
        rarity: "RARE",
        xpAwarded: 150,
        metadata: { bnccCodes: ["EF01LP01", "EF01LP03"] },
      },
      {
        code: "badge:mensageiro-amigo",
        title: "Mensageiro Amigo",
        description: "Planejou e revisou bilhetes com clareza e carinho.",
        criteria: "Enviar um bilhete para a turma utilizando modelos revisados.",
        icon: "badge-mail",
        category: "BADGE",
        rarity: "COMMON",
        xpAwarded: 90,
        metadata: { bnccCodes: ["EF01LP09", "EF01LP10"] },
      },
      {
        code: "level:3",
  ...
  {
    email: "lara.ciencias@aprender.dev",
    name: "Lara Mendes",
    displayName: "Lara",
    ageGroupSlug: "fundamental-anos-iniciais",
    learningPathSlugs: ["exploradores-da-natureza"],
    xp: 1040,
    level: 3,
    nextLevelAt: computeNextLevelAt(3),
    currentStreak: 3,
    ...
    progress: [
      {
        contentModuleSlug: "sentidos-curiosos",
        completion: 58,
        status: "IN_PROGRESS",
        totalAttempts: 4,
        currentStreak: 2,
      ...
      {
        contentModuleSlug: "cuidados-do-corpo",
        completion: 52,
        status: "IN_PROGRESS",
        totalAttempts: 4,
        currentStreak: 3,
        bestStreak: 4,
        averageAccuracy: 0.81,
        averageTimeSeconds: 108,
        mastery: 63,
      },
      {
        contentModuleSlug: "animais-da-vizinhanca",
        completion: 44,
        status: "IN_PROGRESS",
        totalAttempts: 3,
        currentStreak: 2,
      ...
      {
        contentModuleSlug: "plantas-que-cuidamos",
        completion: 36,
        status: "IN_PROGRESS",
        totalAttempts: 3,
        currentStreak: 2,
      ...
      {
        contentModuleSlug: "ambientes-da-escola",
        completion: 30,
        status: "IN_PROGRESS",
        totalAttempts: 2,
        currentStreak: 1,
    ...
    attempts: [
      {
        activitySlug: "ouvido-atento",
        success: true,
        score: 88,
        accuracy: 0.86,
        timeSpentSeconds: 92,
        metadata: { pistaFavorita: "sino da escola" },
      },
      {
        activitySlug: "rota-dos-sentidos",
        success: true,
        score: 95,
        accuracy: 0.9,
        timeSpentSeconds: 85,
        metadata: { equipe: "Estrela Azul" },
      },
      {
        activitySlug: "patrulha-biodiversidade",
        success: true,
        score: 90,
        accuracy: 0.88,
        timeSpentSeconds: 140,
        metadata: { acaoEscolhida: "mutirao-limpeza" },
      },
      {
        activitySlug: "laboratorio-do-plantio",
        success: true,
        score: 84,
        accuracy: 0.82,
        timeSpentSeconds: 150,
        metadata: { material: "algodao" },
      },
      {
        activitySlug: "guardioes-dos-espacos",
        success: true,
        score: 92,
        accuracy: 0.89,
        timeSpentSeconds: 130,
        metadata: { papel: "coordenadora" },
      },
      {
        activitySlug: "desafio-da-reciclagem",
        success: false,
        score: 60,
        accuracy: 0.6,
        timeSpentSeconds: 70,
        metadata: { observacao: "confundiu lixeira azul" },
      },
    ],
    rewards: [
      {
        code: "badge:guardiao-natureza",
        title: "Guardião da Natureza",
        description: "Concluiu missões de cuidado com jardins e habitats.",
        criteria: "Finalizar três atividades dos módulos de Ciências EF01.",
        icon: "badge-leaf",
        category: "BADGE",
        rarity: "RARE",
        xpAwarded: 180,
        metadata: { learningPath: "exploradores-da-natureza" },
      },
      {
        code: "collectible:caderno-campo",
        title: "Caderno de Campo Ilustrado",
        description: "Registrou observações em todas as aulas da semana de Ciências.",
        criteria: "Preencher registros de observação para cinco atividades seguidas.",
        icon: "notebook",
        category: "COLLECTIBLE",
        rarity: "COMMON",
        xpAwarded: 90,
        metadata: { favorito: "laboratorio-do-plantio" },
      },
    ],
    competencies: [
      {
